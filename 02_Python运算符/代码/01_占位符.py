...
print(f'大家好，我是{name}，我今年{age}岁，我的年薪{salary}亿')
...
#   %% : 百分号
print('大家好，我是%s，我今年%d岁，我的年薪%.2f亿' % (name, age, salary))

# 花括号占位符.format() （了解）
print('大家好，我是{}，我今年{}岁，我的年薪{}亿'.format(name, age, salary))
print('大家好，我是{a}，我今年{b}岁，我的年薪{c}亿'.format(a=name, b=age, c=salary))
